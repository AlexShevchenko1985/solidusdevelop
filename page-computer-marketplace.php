...
<section id="section1" class="hero-section">
    ...
    <div class="container">
        ...
        <video playsinline="" autoplay="" muted="" loop="" poster="">
            <?php if (!empty($hero['video_mp4'])): ?>
                <source src="<?php echo $hero['video_mp4']; ?>" type="video/mp4">
            <?php endif; ?>
            <?php if (!empty($hero['video_webm'])): ?>
                <source src="<?php echo $hero['video_webm']; ?>" type="video/webm">
            <?php endif; ?>
        </video>
        ...
        <div class="partners">
            ...
            <a href="<?php echo esc_url($partner['link']) ?>" class="partners__item"><img src="<?php echo esc_url($partner['logo']) ?>" alt=""></a>
            <?php endforeach; ?>
        </div>
        <?php endif; ?>
    </div>
                ...
                <div class="info-item small hover-video">
                    ...
                    <div class="img-wrap">
                        <video playsinline muted loop>
                            <source src="<?php echo get_template_directory_uri() . '/build/video/Protection-2X.mp4' ?>" type="video/mp4">
                            <source src="<?php echo get_template_directory_uri() . '/build/video/Protection-2X.webm' ?>" type="video/webm">
                        </video>
                        <img src="<?php echo get_template_directory_uri() ?>/src/img/card-mobile-img3.webp" alt="Icon">
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="info-item tab-img">
                    ...
                    <div class="content-wrap">
                        <div class="switcher">
                            ...
                            <span class="right" data-src="<?php echo esc_url( $section_3['item_5']['h100'] ) ?>" data-src_mobile="<?php echo esc_url( $section_3['item_5']['h100_mobile'] ) ?>">H200</span>
                        </div>
